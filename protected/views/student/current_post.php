...
<input type="hidden" name="post" id="past_count" value="<?php  if(isset($data['past_results'])){ echo count($data['past_results']);}else {echo 0;}?>"  />
<?php }?>
        ...
        <input type="hidden" name="employerid" id="employerid" value="<?php echo $current_post['employer_id'] ?>"  />
          ...
          <div id="msg_<?php echo  $current_post['id'] ?>" class="alert hide"></div>
	        ...
	        <div class="toolbar">
				...
				<!--<div class="toolbar-item"><a href="javascript:void(0)" onclick="delete_post('<?php //echo $current_post['id']?>','<?php //echo $current_post['title']?>','<?php //echo $current_post['employer_id']?>')" ><img src="<?php //echo Yii::app()->request->baseUrl; ?>/images/icons/delete.png" alt="edit"/>Delete</a></div>-->
      ...
      <tbody>
		...
		<?php 
          ...
          <div class="col2" style="text-align:center;">
	        		...
	        		<h4> <br /><br />No Current Post<br /><br /><br /></h4>
